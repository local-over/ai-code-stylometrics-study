...
[![Dataset: 149 Programs](https://img.shields.io/badge/Dataset-149%20Programs-emerald.svg)](dataset/)
...
## 📊 Primary Frontier Model Study: Human Reference ($n=10$) vs. Frontier LLMs ($N=89$)
...
├── dataset/
│   ├── master_code_dataset.json     # Master JSON array (149 complete records)
